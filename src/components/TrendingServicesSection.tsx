...
const TRENDING_SLIDES = [
  ...
  },
  {
    ...
    alt: 'Geyser Cleaning & Heating Element Repair',
    badge: '🔥 Geyser Cleaning & Fitting',
    title: 'Geyser Repair & Installation',
  },
  {
    id: 'tank-cleaning',
    src: '/trending/trending-3.png',
    alt: 'Water Tank Deep Cleaning & Disinfection',
    badge: '🛢️ Water Tank Cleaning',
    title: 'Overhead Tank Cleaning & Scrubbing',
  },
];
